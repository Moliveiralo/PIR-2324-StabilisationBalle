###########################################################################
## Makefile generated for Simulink model 'cameraTest'. 
## 
## Makefile     : cameraTest.mk
## Generated on : Tue Feb 27 14:26:54 2024
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/cameraTest.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = $(MATLAB_WORKSPACE)/U/MATLAB
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/cameraTest.elf
...
DEFINES_STANDARD = -DMODEL=cameraTest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/linux/blocks/sfcn/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/linux/blocks/sfcn/src/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/linux/blocks/sfcn/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.c.o : $(START_DIR)/cameraTest_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/cameraTest_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/cameraTest_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_SDL_video_display.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/linux/src/MW_SDL_video_display.c
	$(CC) $(CFLAGS) -o "$@" "$<"


v4l2_capture.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/linux/blocks/sfcn/src/v4l2_capture.c
	$(CC) $(CFLAGS) -o "$@" "$<"


v4l2_capture_linux.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020a/toolbox/realtime/targets/linux/blocks/sfcn/src/v4l2_capture_linux.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/cameraTest_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cameraTest.c.o : $(START_DIR)/cameraTest_ert_rtw/cameraTest.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cameraTest_data.c.o : $(START_DIR)/cameraTest_ert_rtw/cameraTest_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
